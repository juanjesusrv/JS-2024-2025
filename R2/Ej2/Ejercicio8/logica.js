...
function ej() { 
    let n = prompt("Introduce el primer valor: "); 

    while (n < -50 || n > 50 || n != parseInt(n)) {
        n = prompt("Introduce un número entre -50 y 50: ");
    }

    let m = prompt("Introduce el segundo valor: "); 

    while (m < 1 || m > 20 || m != parseInt(m)) {
        m = prompt("Introduce un número entre 1 y 20: ");
    }
