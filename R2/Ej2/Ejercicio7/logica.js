...
function ej() { 
    let n = prompt("Introduce un numero impar: "); //Pedimos al usuario que introduzca su calificación numérica 

    while (n % 2 == 0 || n == 0 || n != parseInt(n)) {
        n = prompt("Introduce un número impar: ");
    }
